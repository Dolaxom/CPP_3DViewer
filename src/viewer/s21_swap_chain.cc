...
S21SwapChain::S21SwapChain(S21Device& deviceRef, VkExtent2D extent)
...
VkResult S21SwapChain::acquireNextImage(uint32_t* imageIndex) {
...
VkResult S21SwapChain::submitCommandBuffers(const VkCommandBuffer* buffers,
                                            uint32_t* imageIndex) {
...
void S21SwapChain::createSwapChain() {
...
void S21SwapChain::createImageViews() {
...
void S21SwapChain::createRenderPass() {
...
void S21SwapChain::createFramebuffers() {
...
void S21SwapChain::createDepthResources() {
...
void S21SwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR S21SwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR S21SwapChain::chooseSwapPresentMode(
...
VkExtent2D S21SwapChain::chooseSwapExtent(
...
VkFormat S21SwapChain::findDepthFormat() {
